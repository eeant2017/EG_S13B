...
#include "uart.h"
 uint8_t  rfid[8];
 uint8_t  ISO15693_Init(void);
 uint8_t  ISO15693_Stayquite(void);
 uint8_t  ISO15693_Inventory(uint8_t  *rece_len,uint8_t  *buff,uint8_t  *card_uid,uint8_t  *slot_num);
 uint8_t  ISO15693_Select(uint8_t  *card_uid,uint8_t  *rece_len,uint8_t  *buff);
 uint8_t  ISO15693_Read(uint8_t  block,uint8_t  *rece_len,uint8_t  *buff);
 uint8_t  ISO15693_Write(uint8_t  card_type,uint8_t  block, uint8_t  *block_data,uint8_t  *rece_len,uint8_t  *buff);
 uint8_t  ISO15693_Getinfo(uint8_t  *rece_len,uint8_t  *buff);
 uint8_t  ISO15693_Inventory_16slot(uint8_t  *card_num,uint8_t  *card_uid);
 uint8_t  ISO15693_Mult_Read(uint8_t  block1,uint8_t  block2,uint8_t  *rece_len,uint8_t  *buff);
/*****************************************************************************************/
/*名称：ISO15693_Init                                                                     */
/*功能：设置通信协议为ISO15693                                                             */
/*输入：N/A                                                                                 */
...
uint8_t  ISO15693_Stayquite(void)
{
    uint8_t  data i,ret,rece_len;
    uint8_t  send_byte[10],buff[1];
    SPIWrite(0x14,0x2f);
    SetTime_Delay(5);
     send_byte[0] = 0x22;
...
uint8_t  ISO15693_Inventory(uint8_t  *rece_len,uint8_t  *buff,uint8_t  *card_uid,uint8_t  *slot_num)
{
uint8_t  data i,j,ret,send_len,mask_len,mask_pos,round,slot_mark;
uint8_t  send_byte[11], mask_value[8];
    mask_len=0;
    mask_pos=0;
...
//{    
//    uint8_t  send_byte[1],*rece_len,*buff;
//    SPIWrite(CoderControl_Reg,(SPIRead(CoderControl_Reg)|0x80));
...
uint8_t  ISO15693_Inventory_16slot(uint8_t  *card_num,uint8_t  *card_uid)
{
uint8_t   i,j,ret,send_len,send_byte[11],mask_len,mask_value[8],mask_pos,round,slot_mark,card_mark,slot_num;
uint8_t   *rece_len,buff[18];
    Rf_Off();
    Rf_On();
    mask_len=0;
    mask_pos=0;
