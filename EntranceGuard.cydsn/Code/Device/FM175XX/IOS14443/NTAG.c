...
*********************************************************************************************************/
uint8_t  NtagBlockread(uint8_t  block,uint8_t  *buff)
{    
...
** Returned value:      TRUE：操作成功 ERROR：操作失败    
*********************************************************************************************************/
uint8_t  NtagBlockwrite(uint8_t  block,uint8_t  *buff)
{    
...
** Returned value:      TRUE：操作成功 ERROR：操作失败    
*********************************************************************************************************/
uint8_t  NtagBlockwriteCompatibility(uint8_t  block,uint8_t  *buff)
{    
    uint8_t   result,send_buff[16],rece_buff[1];
    uint32_t  rece_bitlen;
    Pcd_SetTimer(1);
...
** Returned value:      TRUE：操作成功 ERROR：操作失败    
*********************************************************************************************************/
uint8_t  NtagCounterRead(uint8_t  *buff)
{    
    uint8_t   send_buff[2],result;
    uint32_t  rece_bitlen;
    Pcd_SetTimer(1);
...
** Returned value:      TRUE：操作成功 ERROR：操作失败    
*********************************************************************************************************/
uint8_t  NtagPWD_AUTH(uint8_t  *password,uint8_t  *passwordACK)
{    
    uint8_t   send_buff[6],result;
    uint32_t  rece_bitlen;
    Pcd_SetTimer(1);
...
** Returned value:      TRUE：操作成功 ERROR：操作失败    
*********************************************************************************************************/
uint8_t  NtagReadSIG(uint8_t  *buff)
{    
    uint8_t   send_buff[2],result;
    uint32_t  rece_bitlen;
    Pcd_SetTimer(10);
