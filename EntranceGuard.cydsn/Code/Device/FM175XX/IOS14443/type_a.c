...
** Returned value:      void
*********************************************************************************************************/
void TypeA_Save_UID(uint8_t  Bytes,uint8_t  Bits,uint8_t  length,             \
                      uint8_t  *buff,uint8_t  *picc_uid)
{
    uint8_t  i;
    uint8_t  temp1;
    uint8_t  temp2;
...
** Returned value:      void
*********************************************************************************************************/
void TypeA_Set_BitFraming(uint8_t   bytes,uint8_t   bits,uint8_t  *NVB)
{    
    switch(bytes) {
        case 0: 
            *NVB = 0x20;
...
** Returned value:      TRUE：操作成功 ERROR：操作失败    
*********************************************************************************************************/
uint8_t  TypeA_Anticollision(uint8_t  selcode,uint8_t  *picc_uid)
{
    uint8_t  result,i;
    uint8_t  send_buff[10];
    uint8_t  rece_buff[10];
    uint32_t  rece_bitlen,bitCnt;                                   /* 可以使用 volatile            */
      uint8_t  nBytes,Bits,Pre_nBytes,Pre_Bits;
