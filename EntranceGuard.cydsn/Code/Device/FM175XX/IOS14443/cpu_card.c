...
/* ERROR: 应答错误                        */
/****************************************************************/
uint8_t  CPU_Rats(uint8_t  param1,uint8_t  param2,uint8_t  *rece_len,uint8_t  *buff)
{
    uint8_t   ret,send_byte[2];
...
/* ERROR: 应答错误                        */
/****************************************************************/
uint8_t  CPU_PPS(uint8_t  pps0,uint8_t  pps1,uint8_t  *rece_len,uint8_t  *buff)
{
    uint8_t  data ret,send_byte[3];
...
/*     ERROR: 应答错误                        */
/****************************************************************/
uint8_t  CPU_Random(uint8_t  *rece_len,uint8_t  *buff)
{
    uint8_t  data ret,send_byte[5];
...
/* ERROR: 应答错误                        */
/****************************************************************/
//uint8_t  CPU_auth(uint8_t  *key_buff,uint8_t  *rece_len,uint8_t  *buff)
//{
//    uint8_t  i,ret,send_byte[15],rece_byte[16],Random_data[8],des_buff[8],temp;
//
...
/*     ERROR: 应答错误                        */
/****************************************************************/
uint8_t  CPU_TPDU(uint8_t  send_len,uint8_t  *send_buff,uint8_t  *rece_len,uint8_t  *rece_buff)
{    uint8_t  data ret;
    uint32_t data rece_bitlen;
...
/*     ERROR: 应答错误                        */
/****************************************************************/
 uint8_t  CPU_I_Block(uint8_t  send_len,uint8_t  *send_buff,uint8_t  *rece_len,uint8_t  *rece_buff)
 {
    uint8_t  data ret;
    uint32_t data rece_bitlen;
    Pcd_SetTimer(500);
    ...
    if (ret==OK)
    {
        PCB=*rece_buff;
        CPU_PCB();
        *rece_len=rece_bitlen/(uint32_t)8;
    }
    else
        *rece_len=0;
    return ret;
...
/****************************************************************/
 ...
 uint8_t  CPU_R_Block(uint8_t  *rece_len,uint8_t  *rece_buff)
 {
     uint8_t  data send_buff[2],ret;
    uint32_t data rece_bitlen;
    Pcd_SetTimer(100);
    Clear_FIFO();
    if (PCB&0x08)//判断是否有CID字节
...
/*     ERROR: 应答错误                        */
/****************************************************************/
 uint8_t  CPU_S_Block(uint8_t  pcb_byte,uint8_t  *rece_len,uint8_t  *rece_buff)
 {
   uint8_t  data send_buff[3],ret;
   uint32_t data rece_bitlen;
   Pcd_SetTimer(500);
   Clear_FIFO();
...
/*     ERROR: 应答错误                        */
/****************************************************************/
uint8_t  CPU_BaudRate_Set(uint8_t  mode) //mode=0:106Kbps;1:212Kpbs;2:424Kpbs
{
