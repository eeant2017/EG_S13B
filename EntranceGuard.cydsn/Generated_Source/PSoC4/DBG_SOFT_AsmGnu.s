/******************************************************************************
* File Name: DBG_SOFT_AsmGnu.s
* Version 1.50
*
*  Description:
*   GNU assembly routines for PSoC 4.
*
*******************************************************************************
...
.global DBG_SOFT_pinNumber
.global DBG_SOFT_pinPortNumber
...
/******************************************************************************
* Function Name: DBG_SOFT_PutChar
*******************************************************************************
*
* Summary:
...
.global DBG_SOFT_PutChar
.func DBG_SOFT_PutChar, DBG_SOFT_PutChar
.type DBG_SOFT_PutChar, %function
.thumb_func
DBG_SOFT_PutChar:
...
bitTxLoop:
    ...
    .align 5
PIN_NUMBER:
    .word DBG_SOFT_pinNumber
PORT_NUMBER:
    .word DBG_SOFT_pinPortNumber
PORT_DR_ADDRESS:
    .word DBG_SOFT_pinDrAdress
FREQ:
    .word cydelayFreqHz
BAUD_RATE:
    .word 115200
