...
{
    0x0280u,    /* uint16 advertising_interval_min */
    0x0320u,    /* uint16 advertising_interval_max */
    CYBLE_GAPP_CONNECTABLE_UNDIRECTED_ADV, /* uint8 advertising_type */
    0x00u,      /* uint8 own_addr_type */
    0x00u,      /* uint8 direct_addr_type */
    {0x01u, 0x01u, 0x01u, 0x01u, 0x06u, 0x0Au}, /* uint8* direct_addr */
...
{
    { 0x02u, 0x01u, 0x06u, 0x0Eu, 0x09u, 0x52u, 0x4Bu,
    0x4Au, 0x30u, 0x41u, 0x30u, 0x36u, 0x30u, 0x31u, 0x30u,
    0x31u, 0x30u, 0x31u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
...
{
    { 0x0Eu, 0x09u, 0x52u, 0x4Bu, 0x4Au, 0x30u, 0x41u,
    0x30u, 0x36u, 0x30u, 0x31u, 0x30u, 0x31u, 0x30u, 0x31u,
    0x02u, 0x0Au, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
    0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u }, /* uint8 scan_rsp_data[CYBLE_MAX_SCAN_RSP_DATA_LEN] */
    0x12u,      /* uint8 scan_rsp_data_length */
};
...
CYBLE_GAP_BD_ADDR_T cyBle_deviceAddress = {{0x01u, 0x01u, 0x01u, 0x01u, 0x06u, 0x0Au}, 0x00u };
