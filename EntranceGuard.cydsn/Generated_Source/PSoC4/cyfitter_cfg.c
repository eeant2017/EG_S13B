...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0xEE300000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x0C000000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG4), 0x40000000u);

		/* INT_SELECT Starting address: CYDEV_CPUSS_INT_SEL */
		CY_SET_REG32((void *)(CYREG_CPUSS_INT_SEL), 0x00000002u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT0_BASE), 0x00000022u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00DB6C0Eu);

	/* IOPINS0_1 Starting address: CYDEV_GPIO_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x000000A4u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00231C76u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC2), 0x00000020u);

	/* IOPINS0_2 Starting address: CYDEV_GPIO_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT2_BASE), 0x00000071u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC), 0x00109001u);

	/* IOPINS0_3 Starting address: CYDEV_GPIO_PRT3_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT3_BASE), 0x0000008Bu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x005B63A4u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_INTR_CFG), 0x00008000u);
