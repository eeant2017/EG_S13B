...
#define RTC_INITIAL_SECOND          (25u)
#define RTC_INITIAL_MINUTE          (29u)
#define RTC_INITIAL_HOUR            (10u)
#define RTC_INITIAL_DAY             (3u)
#define RTC_INITIAL_MONTH           (8u)
...
*/
#define RTC_12_HOURS_FORMAT    (RTC__HOUR_12) /**< The 24 hour format */
#define RTC_24_HOURS_FORMAT    (RTC__HOUR_24) /**< The 12 hour (AM/PM) format */
