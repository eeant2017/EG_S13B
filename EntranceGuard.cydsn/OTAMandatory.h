...
#define CYBLE_SL_SERVICE_INDEX   (0x00u) /* Index of SL service in the cyBle_customs array */
#define CYBLE_SL_SL_APP_CMD_CHAR_INDEX   (0x00u) /* Index of sl_app_cmd characteristic */
#define CYBLE_SL_CMD_RSP_CHAR_INDEX   (0x01u) /* Index of cmd_rsp characteristic */
#define CYBLE_SL_CMD_RSP_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
	
	
#define CYBLE_SL_SERVICE_HANDLE   (0x000Eu) /* Handle of SL service */
#define CYBLE_SL_SL_APP_CMD_CHAR_HANDLE   (0x0010u) /* Handle of sl_app_cmd characteristic */
#define CYBLE_SL_CMD_RSP_CHAR_HANDLE   (0x0012u) /* Handle of cmd_rsp characteristic */
#define CYBLE_SL_CMD_RSP_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0013u) /* Handle of Client Characteristic Configuration descriptor */
	
#define CYBLE_LOCK_SERVICE_SERVICE_HANDLE   (0x000Cu) /* Handle of lock_service service */
#define CYBLE_LOCK_SERVICE_DOWN_CHARACTERISTIC_DECL_HANDLE   (0x000Du) /* Handle of Down Characteristic characteristic declaration */
#define CYBLE_LOCK_SERVICE_DOWN_CHARACTERISTIC_CHAR_HANDLE   (0x000Eu) /* Handle of Down Characteristic characteristic */
#define CYBLE_LOCK_SERVICE_UP_CHARACTERISTIC_DECL_HANDLE   (0x000Fu) /* Handle of Up Characteristic characteristic declaration */
#define CYBLE_LOCK_SERVICE_UP_CHARACTERISTIC_CHAR_HANDLE   (0x0010u) /* Handle of Up Characteristic characteristic */
#define CYBLE_LOCK_SERVICE_UP_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0011u) /* Handle of Client Characteristic Configuration descriptor */
...
typedef enum
{
    ...
    CYBLE_HUMAN_INTERFACE_DEVICE_REPORT_IN = CYBLE_HIDS_REPORT, /* Report In characteristic index */
    CYBLE_HUMAN_INTERFACE_DEVICE_REPORT_OUT,         /* Report Out characteristic index */
...
typedef struct
{
    ...
    CYBLE_GATT_DB_ATTR_HANDLE_T customServiceCharDescriptors[1];
...
/** SL Characteristic indexes */
typedef enum
{
    CYBLE_SL_APP_CMD = 0,                            /**<smartlock app cmd characteristic index */
    CYBLE_SL_CMD_RSP,                               
    CYBLE_SL_CHAR_COUNT							/**< Total count of characteristics */
} CYBLE_CUSTOM_CHAR_INDEX_T;

/** SL Characteristic Descriptors indexes */
typedef enum
{
    CYBLE_SL_CMD_RSP_CCCD,                       /**< Client Characteristic Configuration descriptor index */
    CYBLE_SL_DESCR_COUNT                               /**< Total count of descriptors */
} CYBLE_CUSTOM_DESCR_INDEX_T;

typedef struct
{
    CYBLE_CONN_HANDLE_T connHandle;                         /**< Peer device handle */
    CYBLE_CUSTOM_CHAR_INDEX_T charIndex;                       /**< Index of service characteristic */
    CYBLE_GATT_VALUE_T *value;                              /**< Characteristic value */
} CYBLE_CUSTOM_CHAR_VALUE_T;
...
typedef enum 
{
     /** CPS Server - Notifications for Cycling Power Service Characteristic
        ...
        CYBLE_CPS_CHAR_VALUE_T type.
    */
    CYBLE_EVT_CUSTOM_NOTIFICATION_ENABLED,
    
    /** CPS Server - Notifications for Cycling Power Service Characteristic
        were disabled. The parameter of this event is a structure 
        of CYBLE_CPS_CHAR_VALUE_T type
    */
    CYBLE_EVT_CUSTOM_NOTIFICATION_DISABLED,
    
    /** CPS Server - Indication for Cycling Power Service Characteristic
        was enabled. The parameter of this event is a structure 
        of CYBLE_CPS_CHAR_VALUE_T type
    */
    CYBLE_EVT_CUSTOM_INDICATION_ENABLED,
    
    /** CPS Server - Indication for Cycling Power Service Characteristic
        was disabled. The parameter of this event is a structure 
        of CYBLE_CPS_CHAR_VALUE_T type
    */
    CYBLE_EVT_CUSTOM_INDICATION_DISABLED,
    
    /** CPS Server - Cycling Power Service Characteristic
        Indication was confirmed. The parameter of this event
        is a structure of CYBLE_CPS_CHAR_VALUE_T type
    */
    CYBLE_EVT_CUSTOM_INDICATION_CONFIRMED,
    
    /** CPS Server - Broadcast for Cycling Power Service Characteristic
        was enabled. The parameter of this event
        is a structure of CYBLE_CPS_CHAR_VALUE_T type
    */
    CYBLE_EVT_CUSTOM_BROADCAST_ENABLED,
    
    /** CPS Server - Broadcast for Cycling Power Service Characteristic
        was disabled. The parameter of this event
        is a structure of CYBLE_CPS_CHAR_VALUE_T type
    */
    CYBLE_EVT_CUSTOM_BROADCAST_DISABLED,
    
    /** CPS Server - Write Request for Cycling Power Service Characteristic 
        was received. The parameter of this event is a structure
        of CYBLE_CPS_CHAR_VALUE_T type.
    */
    CYBLE_EVT_CUSTOM_CHAR_WRITE,
	
} CYBLE_CUSTOM_EVENT_T;
...
//add by chensq
extern CYBLE_API_RESULT_T CyBle_CustomSendNotification(CYBLE_CONN_HANDLE_T connHandle,
    CYBLE_CUSTOM_CHAR_INDEX_T charIndex, uint8 attrSize, uint8 *attrValue);
extern void CyBle_CustomRegisterAttrCallback(CYBLE_CALLBACK_T callbackFunc);
