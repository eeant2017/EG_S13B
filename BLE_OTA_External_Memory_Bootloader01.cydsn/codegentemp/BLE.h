...
#define CYBLE_GAP_ROLE_BROADCASTER                  (0u != (CYBLE_GAP_ROLE & CYBLE_GAP_BROADCASTER))
    ...
    #define CYBLE_FAST_ADV_INT_MIN                  (0x0280u)
    ...
    #define CYBLE_GAPP_CONNECTION_SLAVE_LATENCY     (0x0002u)
...
#define CYBLE_SCN_PKT_INDEX_TX_POWER_LEVEL   (0x0Fu)
...
#define CYBLE_GATT_MAX_ATTR_LEN             ((0x0090u == 0u) ? (1u) : (0x0090u))
