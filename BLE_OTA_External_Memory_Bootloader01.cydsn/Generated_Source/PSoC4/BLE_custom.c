...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    {
        0x000Cu, /* Handle of the lock_service service */ 
        {

            /* Down Characteristic characteristic */
            {
                0x000Eu, /* Handle of the Down Characteristic characteristic */ 
            ...
            /* Up Characteristic characteristic */
            {
                0x0010u, /* Handle of the Up Characteristic characteristic */ 
