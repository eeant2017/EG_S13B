...
#define CYBLE_LOCK_SERVICE_SERVICE_INDEX   (0x00u) /* Index of lock_service service in the cyBle_customs array */
#define CYBLE_LOCK_SERVICE_DOWN_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Down Characteristic characteristic */
#define CYBLE_LOCK_SERVICE_UP_CHARACTERISTIC_CHAR_INDEX   (0x01u) /* Index of Up Characteristic characteristic */
#define CYBLE_LOCK_SERVICE_UP_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
