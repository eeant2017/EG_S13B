...
::
set LOADER_PRJ_NAME=BLE_OTA_External_Memory_Bootloader01
set LOADER_PRJ_PATH=%~dp0..\
set LOADABLE_PRJ_NAME=EntranceGuard
...
set CREATOR_VERSION=4.0
set CREATOR_LOCATION=%PROGRAM_FILES_PATH%\Cypress\PSoC Creator

::
::  Compiler choice. Currently only GCC 4.9.3, MDK and IAR compilers are supported.
::
set GCC_COMPILER=ARM_GCC_493
...
set UTILS_NM=%CREATOR_LOCATION%\%CREATOR_VERSION%\PSoC Creator\import\gnu\arm\4.9.3\bin\arm-none-eabi-nm.exe
